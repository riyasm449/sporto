          ...
          child: Column(
            children: [
              Stack(
                children: [
                  Container(
                    ...
                    child: (widget.shopDetails.imgUrl == null ||
                            widget.shopDetails.imgUrl == '')
                        ? Image.asset(
                  ...
                  if (widget.shopDetails.imgUrl != null &&
                      widget.shopDetails.imgUrl != '')
                    Container(
                      height: 240,
                      width: MediaQuery.of(context).size.width,
                  ...
                  Positioned(
                    ...
                    child: Text(
                      ...
                      style: TextStyle(
                          color: (widget.shopDetails.imgUrl != null &&
                                  widget.shopDetails.imgUrl != '')
                              ? Colors.white
                              : Colors.black,
                          fontSize: 25,
              ...
              textField(context,
                  ...
                  value: widget.shopDetails.sportsOffered ??
              ...
              Padding(
                ...
                child: ListTile(
                  ...
                  title: Text(
                    widget.shopDetails.contactNumber ?? 'Number not available',
                    style: TextStyle(
                        color: Colors.black87,
                        fontSize: 16,
                        fontWeight: FontWeight.bold),
              ...
              Padding(
                ...
                child: ListTile(
                  ...
                  title: Text(
                    widget.shopDetails.address ?? 'Address',
                    style: TextStyle(
                        color: Colors.black87,
                        fontSize: 16,
                        fontWeight: FontWeight.bold),
